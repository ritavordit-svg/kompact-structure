...
exports.createUserV2 = (req, res) => {
    try {
        ...
        exports
            .addUserMongodbV2(req.body)
            .then((respo) => {
                if (!req.body.isInvitation) {
                    sendMailRef
                        .sendVerificationEmailPromise(respo.statusText._id, respo.statusText.Employee_Email)
                        .catch((error) => {
...
exports.generateToken = async (req, res) => {
    try {
        ...
        mongoRef
            .MongoDbCrudOpration("global", object, "findOne")
            .then(async (response) => {
                const companyIds =
                    response.AssignCompany && response.AssignCompany.length ? response.AssignCompany : [];
